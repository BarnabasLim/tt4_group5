...
function App() {
  ...
  useEffect(()=>{
    ...
    // })
    // loans.forEach((loan)=>{
    //   v9_firestore.db_addLoans(loan, ()=>{console.log("sucess")},(e)=>{console.log(e)})
    // })

    // Curtomer_loans.forEach((cutomerLoanItem)=>{
    //   v9_firestore.db_addLoanToCutomers(cutomerLoanItem,()=>{console.log("success")}, (e)=>{console.log(e)})
    // })
    // loan_payment.forEach((payment)=>{
    //   v9_firestore.db_addPaymenttoLoans(payment,()=>{console.log("success")}, (e)=>{console.log(e)})
    // })
